...
export const hubPortals: Record<HubPortalId, HubPortalConfig> = {
  ...
  "total-war": {
    ...
    eyebrow: t("Total War: Warhammer III · экономика кампании · 8.1.1", "Total War: Warhammer III · campaign economy · 8.1.1"),
    ...
    sourceLabel: t("Creative Assembly · хотфикс 8.1.1", "Creative Assembly · Hotfix 8.1.1"),
    sourceUrl: "https://community.creative-assembly.com/total-war/total-war-warhammer/forums/7-patch-notes-amp-announcements/threads/14865",
    stats: [
      { value: "7", label: t("узлов кампании", "campaign links") },
      { value: "3", label: t("пути кампании", "campaign routes") },
      { value: "4", label: t("инструмента решений", "decision tools") },
      { value: guideCount("totalwar"), label: t("полных гайдов", "full guides") }
    ],
    sections: [
      ...
      section("guides", "04", "L", t("Гайды", "Guides"), t("Полевые планы для казны и границы", "Field plans for treasury and frontier"), t("Пять полных гайдов: режимы кампании, подготовка казны, военный резерв, окупаемость здания и выбор после захвата.", "Five full guides covering campaign modes, war-chest preparation, the frontier reserve, building payback and the post-conquest choice."), t("Получишь пошаговый сценарий, а не совет в вакууме", "Get a stepwise case, not advice in a vacuum"), t("Как проверить решение перед следующей войной?", "How do I test a decision before the next war?")),
      section("tools", "05", "Σ", t("Инструменты", "Tools"), t("Штаб кампании и три точные модели", "Campaign command and three focused models"), t("Выбери фазу, проведи общий стресс-тест казны, затем открой отдельную модель здания, резерва или захвата.", "Choose the phase, run a campaign-wide treasury stress test, then open the focused building, reserve or conquest model."), t("Получишь порядок действий и проверишь плохой сценарий", "Get an action order and run the adverse case"), t("Выдержит ли план неожиданный новый фронт?", "Can the plan survive an unexpected new front?"))
    ],
    media: [
      {
