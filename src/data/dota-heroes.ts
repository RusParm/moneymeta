export interface DotaHeroRecord {
  id: number;
  key: string;
  name: string;
  image: string;
...
export const dotaHeroSnapshot = {
  provider: "opendota",
  patchFamily: "7.41",
  checkedAt: "2026-09-02",
  sourceUrl: "https://api.opendota.com/api/constants/heroes"
} as const;
...
export const dotaHeroes: DotaHeroRecord[] = heroRows.map((hero) => ({
  ...hero,
  image: `${heroCdn}/${hero.key}.png`
}));

export const dotaHeroesById = new Map(dotaHeroes.map((hero) => [hero.id, hero]));
