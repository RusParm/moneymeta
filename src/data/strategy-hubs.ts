  ...
  lenses: [
    {
      ...
      cards: [
        { mark: "¤", title: ruEn("Резерв казны", "Treasury reserve"), text: ruEn("Позволяет ответить на внезапную армию или потерю дохода поселения.", "Preserves an answer to a surprise army or lost settlement income."), metrics: [{ label: ruEn("Ликвидность", "Liquidity"), value: ruEn("Высокая", "High") }, { label: ruEn("Задержка", "Delay"), value: ruEn("0 ходов", "0 turns") }] },
        { mark: "P", title: ruEn("Здание с быстрой окупаемостью", "Short income building"), text: ruEn("Работает, если успевает окупиться до следующей большой войны.", "Works when payback fits before the next war window."), metrics: [{ label: ruEn("Доход", "Income"), value: ruEn("Регулярный", "Recurring") }, { label: ruEn("Риск", "Risk"), value: ruEn("Зависит от провинции", "Province-specific") }] },
        { mark: "A", title: ruEn("Вторая армия", "Second army"), text: ruEn("Сильный ход ради темпа, если у цели в казне всё ещё остаётся резерв.", "A strong tempo move only with positive cash at target."), metrics: [{ label: ruEn("Сила сейчас", "Power now"), value: ruEn("Высокая", "High") }, { label: ruEn("Расход", "Burn"), value: ruEn("Постоянный", "Recurring") }] }
      ]
    },
    {
      id: "expansion", label: ruEn("Расширение", "Expansion"), question: ruEn("Куда направить добычу после победы?", "Where should post-victory gold go?"), criteria: ruEn("Текущее ограничение, срок получения пользы и защита нового владения", "Current constraint, time to benefit and protection of the new holding"), note: ruEn("Лучший вариант меняется, если новая граница требует отдельной армии или поселение невозможно удержать.", "The leader changes when the new frontier needs another army or the settlement cannot be held."),
      cards: [
        { mark: "C", title: ruEn("Укрепление провинции", "Province consolidation"), text: ruEn("Решает проблемы с порядком, ростом и доходом в уже защищённой зоне.", "Closes control, growth and income bottlenecks in an already protected area."), metrics: [{ label: ruEn("Накопительный эффект", "Compounding"), value: ruEn("Высокий", "High") }, { label: ruEn("Фронт", "Front"), value: ruEn("Стабильный", "Stable") }] },
        { mark: "¤", title: ruEn("Военный резерв", "War chest"), text: ruEn("Сохраняет свободу действий перед контратакой или внезапным новым фронтом.", "Buys optionality before a counterattack or surprise front."), metrics: [{ label: ruEn("Гибкость", "Flexibility"), value: ruEn("Максимум", "Maximum") }, { label: ruEn("Доход", "Income"), value: ruEn("0", "0") }] },
        { mark: "A", title: ruEn("Новая армия", "New army"), text: ruEn("Оправдана, если быстрее открывает новую добычу, чем опустошает казну.", "Works when it unlocks the next payout faster than it drains the treasury."), metrics: [{ label: ruEn("Темп", "Tempo"), value: ruEn("Высокий", "High") }, { label: ruEn("Содержание", "Upkeep"), value: ruEn("Высокое", "High") }] }
      ]
    },
    {
      id: "late", label: ruEn("Давление поздней игры", "Late-game pressure"), question: ruEn("Что защищает длинную кампанию от каскадного кризиса?", "What protects a long campaign from cascading failure?"), criteria: ruEn("Расходы нескольких фронтов и время на ответ", "Costs across multiple fronts and time to respond"), note: ruEn("В патче 8.1 ИИ поздней игры чаще расширяется, поэтому мирный сценарий нужно проверять и при появлении нового фронта.", "Patch 8.1 makes late-game AI more expansion-oriented, so a peaceful baseline needs sensitivity."),
      cards: [
        { mark: "¤", title: ruEn("Резерв на несколько фронтов", "Multi-front reserve"), text: ruEn("Одновременно покрывает найм, отрицательный чистый доход и ремонт.", "Covers recruitment, negative flow and repairs together."), metrics: [{ label: ruEn("Запас", "Runway"), value: ruEn("По расходам кампании", "Based on campaign costs") }, { label: ruEn("Фронты", "Fronts"), value: ruEn("Несколько", "Multiple") }] },
        { mark: "R", title: ruEn("Глубина найма", "Recruitment depth"), text: ruEn("Сокращает задержку между угрозой и появлением боеспособной армии.", "Reduces the delay between threat and a combat-ready army."), metrics: [{ label: ruEn("Свобода действий", "Optionality"), value: ruEn("Высокая", "High") }, { label: ruEn("Разовый расход", "Capex"), value: ruEn("Средний", "Medium") }] },
        { mark: "P", title: ruEn("Ещё одно доходное здание", "Another income building"), text: ruEn("Полезно только если граница останется защищённой дольше срока окупаемости.", "Useful only when the frontier stays safe beyond payback."), metrics: [{ label: ruEn("Окупаемость", "Payback"), value: ruEn("Долгая", "Long") }, { label: ruEn("Риск", "Risk"), value: ruEn("Высокий", "High") }] }
      ]
    }
  ],
  scenarios: [
...
export const crusaderKingsHub: StrategyHubData = {
  ...
  paths: [
    {
      ...
      constraints: [{ label: ruEn("Горизонт", "Horizon"), value: ruEn("По сроку войны", "Based on war duration") }, { label: ruEn("Фокус", "Focus"), value: ruEn("стабильность", "stability") }, { label: ruEn("Резерв", "Reserve"), value: ruEn("250 золота", "250 gold") }],
  ...
  lenses: [
    {
      ...
      cards: [
        { mark: "D", title: ruEn("Здание в основном домене", "Core domain building"), text: ruEn("Даёт регулярный доход во владении, которое планируется удерживать поколениями.", "Recurring income in a holding intended to stay with the line for generations."), metrics: [{ label: ruEn("Контроль", "Control"), value: ruEn("Высокий", "High") }, { label: ruEn("Окупаемость", "Payback"), value: ruEn("Измеримая", "Measurable") }] },
        { mark: "¤", title: ruEn("Резерв на наследование", "Succession reserve"), text: ruEn("Сохраняет возможность нанять наёмников, раздать подарки или выйти из кризиса фракций.", "Preserves mercenaries, gifts and an exit from a faction crisis."), metrics: [{ label: ruEn("Ликвидность", "Liquidity"), value: ruEn("Максимум", "Maximum") }, { label: ruEn("Доход", "Income"), value: ruEn("0", "0") }] },
        { mark: "A", title: ruEn("Престижная активность", "Prestige activity"), text: ruEn("Может принести большую неденежную пользу, но не должна съедать резерв.", "Can be strong on non-cash return without breaking the buffer."), metrics: [{ label: ruEn("Польза", "Utility"), value: ruEn("Зависит от ситуации", "Scenario-based") }, { label: ruEn("Ликвидность", "Liquidity"), value: ruEn("Низкая", "Low") }] }
      ]
    },
    {
      id: "pre-war", label: ruEn("Перед войной", "Pre-war"), question: ruEn("Что должно быть профинансировано до объявления?", "What must be funded before declaring?"), criteria: ruEn("Длительность войны, постоянные расходы и запас на осложнения", "War duration, recurring costs and a buffer for setbacks"), note: ruEn("Казус белли ещё не является финансовым планом. Начни с ожидаемой длительности войны и военных расходов.", "A casus belli is not a financial plan. Start with war duration and wartime outflow."),
      cards: [
        { mark: "W", title: ruEn("Военная казна", "War chest"), text: ruEn("Покрывает отрицательный баланс, подкрепления и ошибку в оценке длительности войны.", "Covers negative flow, reinforcement and duration error."), metrics: [{ label: ruEn("Запас", "Runway"), value: ruEn("По сроку войны", "Based on war duration") }, { label: ruEn("Резерв", "Buffer"), value: ruEn("Положительный", "Positive") }] },
        { mark: "M", title: ruEn("Возможности профессиональных полков", "Men-at-arms capacity"), text: ruEn("Дополнительная сила оправдана, если новый расход не уничтожает послевоенный резерв.", "Power works when new outflow does not destroy the post-war reserve."), metrics: [{ label: ruEn("Сила", "Power"), value: ruEn("Высокая", "High") }, { label: ruEn("Расход", "Burn"), value: ruEn("Постоянный", "Recurring") }] },
        { mark: "B", title: ruEn("Новое здание", "New building"), text: ruEn("Долгая окупаемость проигрывает срочной подготовке к войне.", "Long payback is weak before an immediate war window."), metrics: [{ label: ruEn("Окупаемость", "Payback"), value: ruEn("Позже", "Later") }, { label: ruEn("Темп", "Tempo"), value: ruEn("Низкий", "Low") }] }
      ]
    },
    {
      id: "succession", label: ruEn("Передача власти", "Succession"), question: ruEn("Что должен получить наследник кроме титула?", "What should the heir receive besides a title?"), criteria: ruEn("Доступная казна, расходы перехода и изменение дохода", "Available treasury, transition costs and income changes"), note: ruEn("Целевой резерв растёт, если наследник слаб, преемство оспаривается или идёт внешняя война.", "Raise the reserve target for a weak heir, disputed succession or external war."),
      cards: [
        { mark: "S", title: ruEn("Ликвидность наследника", "Heir liquidity"), text: ruEn("Позволяет реагировать, пока новый правитель ещё не восстановил контроль.", "Funds a response before the new ruler restores control."), metrics: [{ label: ruEn("Доступ", "Access"), value: ruEn("Сразу", "Immediate") }, { label: ruEn("Гибкость", "Flexibility"), value: ruEn("Максимум", "Maximum") }] },
        { mark: "D", title: ruEn("Устойчивый профицит домена", "Durable domain surplus"), text: ruEn("Снижает ежемесячную нагрузку после передачи власти.", "Reduces monthly burn after the transfer of power."), metrics: [{ label: ruEn("Поток", "Flow"), value: ruEn("Регулярный", "Recurring") }, { label: ruEn("Контроль", "Control"), value: ruEn("Высокий", "High") }] },
        { mark: "A", title: ruEn("Последняя дорогая активность", "One last expensive activity"), text: ruEn("Полезна только тогда, когда её польза выше ценности свободы действий, которую потеряет наследник.", "Works only when utility exceeds the heir's lost optionality."), metrics: [{ label: ruEn("Казна", "Cash"), value: ruEn("Отток", "Outflow") }, { label: ruEn("Риск", "Risk"), value: ruEn("Высокий", "High") }] }
      ]
    }
  ],
  scenarios: [
    ...
    { mark: "S", mode: ruEn("Наследование", "Succession"), eyebrow: ruEn("18 месяцев", "18 months"), question: ruEn("Выдержит ли казна расходы после передачи власти?", "Can the treasury absorb costs after succession?"), outcome: ruEn("Проверь заданную казну при разовых расходах, новом содержании и изменении дохода.", "Test your starting treasury against one-off costs, added upkeep and an income change."), href: "#succession-buffer" },
  ...
  models: [
    ...
    {
      id: "succession-buffer", kind: "reserve", mark: "S", kicker: ruEn("Модель 03 · устойчивость династии", "Model 03 · dynasty continuity"), title: ruEn("Резерв после передачи власти", "Reserve after succession"), text: ruEn("Задай доступную казну, текущие доходы и расходы. Проверь, сохранится ли резерв после выбранного разового расхода и нового содержания. Раздел владений и фактическое наследство модель не рассчитывает.", "Enter the available treasury and current income and costs. Check whether the reserve survives your chosen one-off cost and added upkeep. The model does not calculate partition or actual inheritance."), note: ruEn("Новый расход здесь означает временную цену перехода: подарки, поднятые войска, наёмников или другой тяжёлый сценарий.", "New outflow is the temporary transition cost: gifts, raised forces, mercenaries or another stress case."),
      inputs: [
