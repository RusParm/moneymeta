...
const sanitizeProviderMatch = (value: unknown): SanitizedMatch | null => {
  ...
  const players = raw.players.slice(0, 12).flatMap((entry): SanitizedPlayer[] => {
    ...
    return [{
      ...
      hero_damage: finiteInteger(player.hero_damage, 0, 10_000_000),
      tower_damage: finiteInteger(player.tower_damage, 0, 10_000_000),
      hero_healing: finiteInteger(player.hero_healing, 0, 10_000_000),
